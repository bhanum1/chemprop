...
class Metric(LossFunction):
    ...
    def forward(
        ...
        return self._calc_unreduced_loss(preds, targets, mask, lt_mask, gt_mask, temps)[mask].mean()

    @abstractmethod
    def _calc_unreduced_loss(self, preds, targets, mask, lt_mask, gt_mask, temps) -> Tensor:
        pass
